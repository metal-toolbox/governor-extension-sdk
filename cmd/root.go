...
import (
	...
	"github.com/metal-toolbox/governor-extension-sdk/pkg/erdscli"
...
const appName = "governor-extension-sdk"
...
var rootCmd = &cobra.Command{
	Use:   appName,
	Short: "governor-extension-sdk",
	Long:  `Governor Extension SDK`,
}
...
func init() {
	...
	rootCmd.Flags().String("erds-path", "erds", "path contains erd files")
	viperBindFlag("erds.path", rootCmd.Flags().Lookup("erds-path"))

	erdscli.RegisterCobraCommand(rootCmd, func() {
		erdscli.SetAppName(appName)
		erdscli.SetLogger(logger.Desugar())
		erdscli.SetERDPath(viper.GetString("erds.path"))
	})
}
